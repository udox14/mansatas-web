...
export default function RecentArticles() {
  ...
  return (
    <section className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      {/* Decorative Blur */}
      <div className="absolute top-1/2 right-0 w-[600px] h-[600px] bg-slate-800/20 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="mb-16">
          ...
          >
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-black text-white tracking-tighter">
              Kabar <span className="text-primary-500">Madrasah</span>
            </h2>
            <Link
              href="/artikel"
              className="group hidden sm:inline-flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 text-white font-bold rounded-full hover:bg-white/10 transition-all duration-300 active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {loading
            ? Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="bg-slate-900 rounded-3xl border border-white/5 h-[450px] animate-pulse" />
              ))
            : articles.map((article, i) => (
                ...
                >
                  <Link
                    ...
                    className="group flex flex-col bg-slate-900 rounded-3xl border border-white/5 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-full"
                  >
                    {/* Thumbnail */}
                    ...
                    {/* Content */}
                    <div className="p-8 flex flex-col flex-1 justify-between relative z-10 -mt-8 bg-slate-900 rounded-t-3xl">
                      <div>
                        ...
                        <h3 className="font-heading font-black text-white mb-4 text-xl lg:text-2xl line-clamp-2 group-hover:text-primary-400 transition-colors leading-tight">
                          {article.title}
                        </h3>
                      ...
                      <div className="flex items-center gap-2 text-xs font-bold text-primary-400 uppercase tracking-widest mt-auto">
